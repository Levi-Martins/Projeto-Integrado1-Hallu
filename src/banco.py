...
len_semestre5 = len(excel_obrigatorias.col_values(14))
len_semestre6 = len(excel_obrigatorias.col_values(17))
len_semestre7 = len(excel_obrigatorias.col_values(20))
len_semestre8 = len(excel_obrigatorias.col_values(23))
